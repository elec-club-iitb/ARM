...
static  OS_STK       AppTask2Stk[APP_TASK_2_STK_SIZE];
static  OS_STK       AppTask3Stk[APP_TASK_3_STK_SIZE];
...
static  void  AppTaskCreate (void)
{
    ...
    OSTaskCreateExt(AppTask2,
                    (void *)0,
                    (OS_STK *)&AppTask2Stk[APP_TASK_2_STK_SIZE - 1],
                    APP_TASK_2_PRIO,
                    APP_TASK_2_PRIO,
    ...
    OSTaskCreateExt(AppTask3,
                    (void *)0,
                    (OS_STK *)&AppTask3Stk[APP_TASK_3_STK_SIZE - 1],
                    APP_TASK_3_PRIO,
                    APP_TASK_3_PRIO,
