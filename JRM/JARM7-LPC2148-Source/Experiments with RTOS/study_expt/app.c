...
#define ADC_SCALE 16
#define MAX_Y_AXIS_VALUE NUM_OF_COL
...
/**
********************************************************************************************
	Function Name :	scaledown_adc_value()
...
**********************************************************************************************
*/
unsigned short int scaledown_adc_value(unsigned short int adc_value)
{
  unsigned short int scaled_value = 0;

  scaled_value = adc_value/ADC_SCALE;
  return(scaled_value - 9);
}

/**
********************************************************************************************
	Function Name :	draw_graph_on_glcd()
...
**********************************************************************************************
*/
void draw_graph_on_glcd(unsigned short int x, unsigned short int y)
{
  put_pixel(x,y,1);
}	 
...
static  void  AppTaskStart (void *p_arg)
{
	unsigned short int adc_value = 0, scaled_value = 0;
	static unsigned short int sec_count = INITIAL_Y_AXIS_POS;
    ...
    scaled_value = scaledown_adc_value(adc_value);
    draw_graph_on_glcd(scaled_value, sec_count);
    if(sec_count == MAX_Y_AXIS_VALUE)
    {
      sec_count = INITIAL_Y_AXIS_POS;
	  LCD_CLEAR();
	  clear_frame_buf();
	  init_xy_axis();
    }
