...
extern int DAC_raw[];		// storing DAC value to output continuously and periodically
...
void displayGraph(int * graphData,int len,int color,bool isBackground= true);
void displayXY_Plot(int * graphData1,int* graphData2,int size,int color, bool isBackground = true);
void displayFFT_Plot(int * graphData,int len, int color, bool isBackground = true);
#endif